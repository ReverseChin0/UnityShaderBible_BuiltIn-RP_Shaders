Shader "Unlit/USB_diffuse_shading"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                return colorRefl * lighInt * max(0, dot(normal, lightDir));    
            }
            ...
            v2f vert (appdata v)
            {
                ...
                o.normal_world = normalize(mul(unity_ObjectToWorld, float4(v.normal, 0))).xyz;//optimizamos el proceso de transformacion
