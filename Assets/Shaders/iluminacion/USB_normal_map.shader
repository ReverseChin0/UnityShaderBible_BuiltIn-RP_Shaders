Shader"Unlit/USB_normal_map"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                v2f o;
                //en caso de que hubiera errores de que no esta totalmente inicializado
                ...
                //transformamos las normales a world-space
                o.normal_world = normalize(mul(unity_ObjectToWorld, float4(v.normal, 0)));
                //transformamos las tangentes a world-space
                o.tangent_world = normalize(mul(v.tangent, unity_WorldToObject));
                //calculamos el producto cruz entre las normales y tangentes
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed3 normal_compressed = DXTCompression(normal_map); //equivalente a unpackNOrmal de UNityCg.cginc
