Shader "Unlit/USB_simple_color_URP"
{
    ...
    { // configuración de SubShader en este bloque
        Tags { 
            ...
            "Queue"="Transparent"
            "RenderPipeline"="UniversalRenderPipeline" //GPU ahora sabe que este shader sera compatible en este pipeline
        }
        LOD 100
        ...
        Pass
        {
            HLSLPROGRAM //remplaza a CGPROGRAM
            // programa Cg - HLSL en este bloque
            #pragma vertex vert
            #pragma fragment frag
            
            //remplazados por vore.hlsl #pragma multi_compile_fog
            ...
            //remplazados por core.hlsl #include "UnityCG.cginc"

            //#include "HLSLSupport.cginc" //añade soporte para fixed4
            ...
            {
                float2 uv : TEXCOORD0;
                // ya no servira UNITY_FOG_COORDS(1)
            ...
            v2f vert (appdata v)
            {
                ...
                //ya no servira UNITY_TRANSFER_FOG(o,o.vertex);
                return o;
            }
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // apply fog
                //ya no servira UNITY_APPLY_FOG(i.fogCoord, col);
                // #if _ENABLE_ON
                //     return col;
                // #else
                //     return col * _Color;
